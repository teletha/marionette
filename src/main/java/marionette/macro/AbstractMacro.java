...
public abstract class AbstractMacro<Self extends AbstractMacro> implements Extensible {
    ...
    Predicate<Window> windowCondition = ANY;
     ...
     */
    public static class KeyMacro implements MacroDSL {

        /** The window condition. */
        private Predicate<Window> windowConditon;
         ...
         */
        private KeyMacro(Key key, Predicate<Window> windowConditon) {
            this.key = key;
